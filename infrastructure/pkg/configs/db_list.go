...
func (i SpecializedDB) DbTypeParam() string {
	return i.DbType
}

func (i SpecializedDB) HostParam() string {
	return i.Host
}

func (i SpecializedDB) PortParam() uint {
	return i.Port
}

func (i SpecializedDB) ConfigParam() string {
	return i.Config
}

func (i SpecializedDB) DbnameParam() string {
	return i.Dbname
}

func (i SpecializedDB) UsernameParam() string {
	return i.Username
}

func (i SpecializedDB) PasswordParam() string {
	return i.Password
}
