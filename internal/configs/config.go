...
type Server struct {
	...
	MainDB     SpecializedDB    `mapstructure:"main-db" yaml:"main-db"`
	MainCache  SpecializedCache `mapstructure:"main-cache" yaml:"main-cache"`
	TenantList []Tenant         `mapstructure:"tenant-list" yaml:"tenant-list"`
	WxMini     WxMini           `mapstructure:"wx-mini" yaml:"wx-mini"`
	WxPub      WxPub            `mapstructure:"wx-pub" yaml:"wx-pub"`
}
